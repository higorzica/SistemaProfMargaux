...
<div class="grid grid-cols-12 gap-6 mb-6">
    <div class="col-span-12 sm:col-span-6 xl:col-span-3">
        <div
            class="md:rounded dark:bg-gray-300/70 block bg-white border border-gray-100 dark:border-gray-900 mx-6 md:mx-0 rounded">
            <!---->
            <div class="p-6">
                <div class="justify-between items-center flex mb-3">
                    <div class="flex shrink-1 grow-9 items-center justify-center">
                        <div
                            class="inline-flex items-center capitalize border py-0.5 px-2 text-xs rounded-lg bg-purple-600 text-white border-emerald-700 mr-1.5 last:mr-0">
